...
export const merge_config_json: (a: number, b: number) => [number, number, number, number];
export const parse_mes_to_json: (a: number, b: number) => [number, number, number, number];
